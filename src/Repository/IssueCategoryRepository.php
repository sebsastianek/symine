...
/**
 * Repository for entity IssueCategory.
 * 
...
class IssueCategoryRepository extends ServiceEntityRepository
{
     ...
     */
    public function find($id, $lockMode = null, $lockVersion = null): ?IssueCategory
    {
     ...
     */
    public function findOneBy(array $criteria, array $orderBy = null): ?IssueCategory
    {
