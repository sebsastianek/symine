...
class ChangeRepository extends ServiceEntityRepository
{
     ...
     */
    public function find($id, $lockMode = null, $lockVersion = null): ?Change
    {
     ...
     */
    public function findOneBy(array $criteria, array $orderBy = null): ?Change
    {
