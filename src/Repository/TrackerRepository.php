...
class TrackerRepository extends ServiceEntityRepository
{
     ...
     */
    public function find($id, $lockMode = null, $lockVersion = null): ?Tracker
    {
     ...
     */
    public function findOneBy(array $criteria, array $orderBy = null): ?Tracker
    {
