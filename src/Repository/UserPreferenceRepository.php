...
/**
 * Repository for entity UserPreference.
 * 
...
class UserPreferenceRepository extends ServiceEntityRepository
{
     ...
     */
    public function find($id, $lockMode = null, $lockVersion = null): ?UserPreference
    {
     ...
     */
    public function findOneBy(array $criteria, array $orderBy = null): ?UserPreference
    {
