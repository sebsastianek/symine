...
/**
 * Repository for entity OauthApplication.
 * 
...
class OauthApplicationRepository extends ServiceEntityRepository
{
     ...
     */
    public function find($id, $lockMode = null, $lockVersion = null): ?OauthApplication
    {
     ...
     */
    public function findOneBy(array $criteria, array $orderBy = null): ?OauthApplication
    {
