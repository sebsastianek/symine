...
class WatcherRepository extends ServiceEntityRepository
{
     ...
     */
    public function find($id, $lockMode = null, $lockVersion = null): ?Watcher
    {
     ...
     */
    public function findOneBy(array $criteria, array $orderBy = null): ?Watcher
    {
     ...
     * Saves an entity.
     */
    public function save(Watcher $entity, bool $flush = false): void
    {
