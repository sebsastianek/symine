...
class GroupsUserFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $groupUser1->setGroup($this->getReference('group-development', \App\Entity\Group::class));
        ...
        $groupUser2->setGroup($this->getReference('group-development', \App\Entity\Group::class));
        ...
        $groupUser3->setGroup($this->getReference('group-development', \App\Entity\Group::class));
        ...
        $groupUser4->setGroup($this->getReference('group-development', \App\Entity\Group::class));
        ...
        $groupUser5->setGroup($this->getReference('group-qa', \App\Entity\Group::class));
        ...
        // Mike Johnson also in QA Team
        $groupUser6 = new GroupsUser();
        $groupUser6->setGroup($this->getReference('group-qa', \App\Entity\Group::class));
        $groupUser6->setUser($this->getReference('user-mjohnson', \App\Entity\User::class));

        $manager->persist($groupUser6);
        $this->addReference('groups-user-qa-mjohnson', $groupUser6);

        // Management group memberships
        // Admin in Management
        $groupUser7 = new GroupsUser();
        $groupUser7->setGroup($this->getReference('group-management', \App\Entity\Group::class));
        ...
        $groupUser8->setGroup($this->getReference('group-management', \App\Entity\Group::class));
        ...
        // Sarah Garcia in Management
        $groupUser9 = new GroupsUser();
        $groupUser9->setGroup($this->getReference('group-management', \App\Entity\Group::class));
        $groupUser9->setUser($this->getReference('user-sgarcia', \App\Entity\User::class));

        $manager->persist($groupUser9);
        $this->addReference('groups-user-mgmt-sgarcia', $groupUser9);

        // Alice Lee in Management
        $groupUser10 = new GroupsUser();
        $groupUser10->setGroup($this->getReference('group-management', \App\Entity\Group::class));
        $groupUser10->setUser($this->getReference('user-alee', \App\Entity\User::class));

        $manager->persist($groupUser10);
        $this->addReference('groups-user-mgmt-alee', $groupUser10);
        ...
        $groupUser11->setGroup($this->getReference('group-qa', \App\Entity\Group::class));
        ...
        $groupUser12->setGroup($this->getReference('group-qa', \App\Entity\Group::class));
