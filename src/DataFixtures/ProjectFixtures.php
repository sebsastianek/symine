...
class ProjectFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $ecommerce->setIsPublic(1);
        $ecommerce->setInheritMembers(0);
        ...
        $frontend->setIsPublic(1);
        $frontend->setInheritMembers(1);
        ...
        $backend->setIsPublic(0); // Private project
        $backend->setInheritMembers(1);
        ...
        $mobile->setIsPublic(0);
        $mobile->setInheritMembers(1);
        ...
        $legacy->setIsPublic(0);
        $legacy->setInheritMembers(0);
        ...
        $prototype->setIsPublic(0);
        $prototype->setInheritMembers(0);
