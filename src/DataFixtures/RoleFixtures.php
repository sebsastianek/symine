...
class RoleFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $manager_role->setAssignable(true);
        $manager_role->setBuiltin(0);
        $manager_role->setAllRolesManaged(true);
        ...
        $developer->setAllRolesManaged(false);
        ...
        $reporter->setAssignable(true);
        $reporter->setBuiltin(0);
        $reporter->setAllRolesManaged(false);
        ...
        $tester->setAssignable(true);
        $tester->setBuiltin(0);
        $tester->setAllRolesManaged(false);
        ...
        $client->setAssignable(true);
        $client->setBuiltin(0);
        $client->setAllRolesManaged(false);
        ...
        $viewer->setAssignable(true);
        $viewer->setBuiltin(0);
        $viewer->setAllRolesManaged(false);
